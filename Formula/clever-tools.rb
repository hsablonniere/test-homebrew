class CleverTools < Formula
  ...
  url "https://clever-tools.clever-cloud.com/releases/3.8.3/clever-tools-3.8.3_macos.tar.gz"
  version "3.8.3"
  sha256 "edeb9e7a67ab25db038a15d0052de83593ab5a11dd8ccb64a0bf883b4b7937db"
