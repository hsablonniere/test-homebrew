class CleverTools < Formula
  ...
  url "https://clever-tools.clever-cloud.com/releases/3.8.0/clever-tools-3.8.0_macos.tar.gz"
  version "3.8.0"
  sha256 "e01b15414dd7bd2bd76996bc096839b0dce4070f8e1496f99b6ce8c1668e55a4"
