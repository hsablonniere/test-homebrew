class CleverTools < Formula
  ...
  url "https://clever-tools.clever-cloud.com/releases/1.6.2/clever-tools-1.6.2_macos.tar.gz"
  version "1.6.2"
  sha256 "3781419484f82fa6e6da1d9aa4fc99caefa3e044ed18a217f1fa23ff2e680268"
