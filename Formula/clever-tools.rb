class CleverTools < Formula
  ...
  url "https://clever-tools.clever-cloud.com/releases/3.13.1/clever-tools-3.13.1_macos.tar.gz"
  version "3.13.1"
  sha256 "0e2da092e5b66a95cad466425979021165b9b1ff28415811f0f28438758df059"
