class CleverTools < Formula
  ...
  url "https://clever-tools.clever-cloud.com/releases/1.19.0/clever-tools-1.19.0_macos.tar.gz"
  version "1.19.0"
  sha256 "bd0e19653894e8aa0af0e00abbed898929cc9418ce265e6db90a8e5a9a9cfed1"
